...
public class UPIServiceImpl implements UPIService {
    private UPIRepositoryImpl upiRepository;
    private UPITransactionRepositoryImpl upiTransactionRepository;

    // Constructor to initialize UPIService with required repositories
    public UPIServiceImpl(UPIRepositoryImpl upiRepository, UPITransactionRepositoryImpl upiTransactionRepository) {
